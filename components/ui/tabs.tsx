...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-xl bg-glass border border-white/10 p-1 text-white/60 backdrop-blur-sm',
      className
    )}
    {...props}
  />
